...
public class PatientService {
    ...
    public void updatePatientStatus(com.covid.dashboard.dto.Patient patient){
        ...
        Optional<com.covid.dashboard.entity.User> byId = userRepository.findById(patient.getUser().getEmail());
        if(byId.isPresent()){
            com.covid.dashboard.entity.User userEntity = byId.get();
            userEntity = new ObjectMapper().convertValue(user, com.covid.dashboard.entity.User.class);
            Patient patientEntity = new ObjectMapper().convertValue(patient, com.covid.dashboard.entity.Patient.class);
            userEntity.setPatient(patientEntity);
